                ...
                <div class="col-span-8 md:col-span-2 lg:col-span-3">
                    ...
                    >
                        ...
                        <div class="flex gap-6">
                            @foreach($footer->list('socials')->columns(['title', 'icon'])->max(7) as $social)
                                <a
                                        href="{{ $social->text('link')->min(1)->max(255) }}"
                                        target="blank"
                                        aria-label="github"
                                        class="hover:text-primary dark:hover:text-primaryLight"
                                >
                                    <span class="sr-only">{{ $social->title }}</span>
                                    <img src="{{ $social->select('icon')->byDirectory('/view/assets/social_icons')->default('github.svg') }}"/>
                                </a>
                            @endforeach
                        </div>
                    </div>
