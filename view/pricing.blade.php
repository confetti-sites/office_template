  ...
  <div class="-mx-4 flex flex-wrap justify-center">
    <div class="w-full px-4 md:w-1/2 lg:w-1/2">
      ...
      >
        ...
        >
          Perfect for a website for a local club, small business or a busy blog."
        </p>
        <div class="mb-7">
          ...
          <p class="text-body-color mb-1 text-base leading-loose">
            SSL-certificate, test environments, caching, backups. All managed by us.
          </p>
        </div>
        <a
    ...
    <div class="w-full px-4 md:w-1/2 lg:w-1/2">
      ...
      >
        ...
        <p class="text-body-color mb-8 border-b border-[#F2F2F2] pb-8 text-base">
            Do you have a high traffic website? Let us handle the stress for you.
        </p>
        <div class="mb-7">
